...
from sarcomere_analysis.zdisc_annotation_features import extract_zdisc_annotation_features


def main() -> None:
    parser = argparse.ArgumentParser(description="Extract per-crop features from manually drawn Z-disc annotation masks.")
    ...
    _, summary, paths = extract_zdisc_annotation_features(
        cfg,
