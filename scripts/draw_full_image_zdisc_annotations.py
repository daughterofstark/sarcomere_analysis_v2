...
from sarcomere_analysis.full_image_annotation import headless_check_full_image_annotations, run_full_image_draw_ui


def main() -> None:
    parser = argparse.ArgumentParser(description="Draw local Z-disc/striation masks on selected full-image PNG working copies.")
    ...
    if args.headless_check:
        summary = headless_check_full_image_annotations(cfg, index_path=args.index)
    ...
    progress_path = run_full_image_draw_ui(
        cfg,
